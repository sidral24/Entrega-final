...
--DECLARACIONES
	...
	BEGIN
		...
		IF EXISTS(SELECT 1 FROM DULCES WHERE ID_DULCE=_ID_DULCE)THEN 
			...
			SELECT STOCK INTO _STOCK FROM DULCES WHERE ID_DULCE=_ID_DULCE;
...
CREATE OR REPLACE PROCEDURE MOVIMIENTO_COMPLETO(_ID_USUARIO NUMERIC, 
_ID_SUCURSAL NUMERIC, _ID_DULCE NUMERIC, _CANTIDAD NUMERIC)
AS
$$
	BEGIN
...
CALL MOVIMIENTO_COMPLETO ( 3, 4, 4, 14);
